...
# 32768 is the max speed of the motor and it has to be divided in half to accommodate the 24 volt power supply protecting the motors from shorting
max_speed = 32768 / 2
...
if (joy.msg.buttons[safety_Trigger_Index] is True):
	...
	right_Wheel_Speed = int(-1 * max_speed * right_Joy_Position)  # -1 is used to reverse the value due to coordinate direction with left wheel
